...
class Herb():
    def __init__(self,test,metadata):
        ...
        self.datapath = paths['Herb_datapath']

        assert self.datapath!=None, "Path missing!! Update 'Herb_datapath' on paths/main.yaml with path to Herbarium images."
